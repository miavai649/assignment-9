...
const Home = () => {
  ...
  return (
    <div>
      <div className="h-[400px] w-full bg-gradient-to-b bg-green-400">
          ...
          <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
            <div className="flex flex-col mb-10 sm:text-center sm:mb-0">
              ...
              <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                ...
                <p className="text-base text-white md:text-lg">A comprehensive database of more than 32 web quizzes online, test your knowledge with web quiz questions. Our online web trivia quizzes can be adapted</p>
              </div>
            </div>
          </div>
        </div>
