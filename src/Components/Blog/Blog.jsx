        ...
        <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
          ...
          <div className="space-y-4">
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none text-2xl focus-visible:ring-green-400"> what is the purpose of the react router?</summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-green-400">
            ...
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none  text-2xl focus-visible:ring-green-400">How does context API works ?</summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-green-400">
            ...
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none  text-2xl focus-visible:ring-green-400">What is the React useRef Hook ?</summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-green-400">
